...
srun --cpus-per-task=1 --time=00:60:00 --job-name=bracken \
    singularity exec -B /proj:/proj $kraken_img bracken -d $kraken_db \
    -i /proj/applied_bioinformatics/users/x_erhar/MedBioinfo/analyses/kraken2/report.txt \
    -o /proj/applied_bioinformatics/users/x_erhar/MedBioinfo/analyses/kraken2/bracken_analysis.txt \
    -w /proj/applied_bioinformatics/users/x_erhar/MedBioinfo/analyses/kraken2/bracken_report.txt
